...
LAB39:    if (*((unsigned int *)t3) < *((unsigned int *)t4))
        goto LAB37;
...
LAB40:    xsi_set_current_line(87, ng0);
    t21 = ((char*)((ng7)));
    t37 = (t0 + 1928);
    xsi_vlogvar_assign_value(t37, t21, 0, 0, 32);
    goto LAB42;
...
{
	static char *pe[] = {(void *)Initial_62_0,(void *)Always_66_1};
	xsi_register_didat("work_m_00000000003816425971_1817473448", "isim/simulation_isim_beh.exe.sim/work/m_00000000003816425971_1817473448.didat");
